...
public class Level2 extends ApplicationAdapter implements Screen {
    ...
    public Level2(final ClickClack game) {
        this.game = game;
...
*/
                ...
                if(fadeIn<200)
                {
                    ...
                    if (winCondition) {
                        ...
                        if (goldBool && prefs.getBoolean("Level2", true)) {
                        ...
                        if (WINTIMER < 0) {
                            ...
                            if(crateHad && prefs.getBoolean("Level2",true)) {
                    ...
                    if (crateGot && prefs.getBoolean("Level2", true)) {
                        if (crateBoolean) {
                            crateTimer -= delta;
