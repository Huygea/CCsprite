...
public class Level3 extends ApplicationAdapter implements Screen {
   ...
   //LEVEL NUMBER
    ...
    public Level3(final ClickClack game) {
        this.game = game;
...
//BROKEN HINGES
        brokenHingeContainer[6][3] = new Vector2(0,0);
        brokenHingeContainer[7][3] = new Vector2(0,0);
        brokenHingeContainer[8][3] = new Vector2(0,0);
        brokenHingeContainer[6][4] = new Vector2(0,0);
        brokenHingeContainer[7][4] = new Vector2(0,0);
        brokenHingeContainer[8][4] = new Vector2(0,0);
