...
public class Level4 extends ApplicationAdapter implements Screen {
    ...
    public Level4(final ClickClack game) {
        this.game = game;
...
*/
                ...
                if(fadeIn<200)
                {
                    ...
                    if (winCondition) {
                        ...
                        if (goldBool && prefs.getBoolean("Level4", true)) {
                        ...
                        if (WINTIMER < 0) {
                            ...
                            if(crateHad && prefs.getBoolean("Level4",true)) {
                    ...
                    if (crateGot && prefs.getBoolean("Level4", true)) {
                        if (crateBoolean) {
                            crateTimer -= delta;
